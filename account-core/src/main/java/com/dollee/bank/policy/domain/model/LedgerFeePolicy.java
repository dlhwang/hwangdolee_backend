...
public class LedgerFeePolicy {
  ...
  protected LedgerFeePolicy(LedgerType type, LocalDateTime effectiveFrom, LedgerFeePolicyDetail detail) {
  ...
  public static LedgerFeePolicy createDefault(LedgerType ledgerType, LocalDateTime baseTime) {
    return new LedgerFeePolicy(ledgerType, baseTime,
        DefaultLedgerFeePolicyRegistry.getDefault(ledgerType));
  }
