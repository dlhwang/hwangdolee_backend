...
public class LedgerFeePolicyEntity extends Policy implements Serializable {
  ...
  protected LedgerFeePolicyEntity(LedgerType ledgerType, LocalDateTime effectiveFrom, LedgerFeePolicyDetail ledgerFeePolicyDetail){
    super(ledgerType, effectiveFrom);
    this.ledgerFeePolicyDetail = ledgerFeePolicyDetail;
  }

  protected LedgerFeePolicyEntity(String id, LedgerType ledgerType, LocalDateTime effectiveFrom, LedgerFeePolicyDetail ledgerFeePolicyDetail){
