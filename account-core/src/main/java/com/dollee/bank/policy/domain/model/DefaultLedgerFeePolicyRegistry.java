...
public class DefaultLedgerFeePolicyRegistry {
  private static final Map<LedgerType, LedgerFeePolicyDetail> DEFAULT_POLICIES = Map.of(
      LedgerType.TRANSFER, LedgerFeePolicyDetail.newInstance(FeeType.정율, TruncateType.NO, 0.01f, 0L)
  );

  public static LedgerFeePolicyDetail getDefault(LedgerType type) {
    return DEFAULT_POLICIES.getOrDefault(type,
        LedgerFeePolicyDetail.newInstance(FeeType.없음, TruncateType.NO, 0f, 0L));
  }
