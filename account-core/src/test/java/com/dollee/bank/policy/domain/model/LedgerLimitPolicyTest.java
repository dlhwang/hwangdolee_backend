...
class LedgerLimitPolicyTest {
  ...
  void testCreateDefaultForWithdrawal() {
    LedgerLimitPolicy domain =
        LedgerLimitPolicy.createDefault(LedgerType.WITHDRAWAL, LocalDateTime.of(2025, 6, 18, 0, 0));
  ...
  void testCreateDefaultForDeposit() {
    LedgerLimitPolicy domain =
        LedgerLimitPolicy.createDefault(LedgerType.DEPOSIT, LocalDateTime.of(2025, 6, 18, 0, 0));
